    ...
    <div id="footer">
      <p>
        Nachádzate sa na stránkach slovenského lokalizačného tímu. &copy; 2004 – <?php echo date('Y'); ?> Mozilla.sk. Všetky práva vyhradené.<br/>
  ...
  </div><?php // END <div id="page"> from header.php ?>
